...
ffmpeg -y -gamma 2.2 -r 20 -i ./out/frame%d_hlevel_0_merge_kernel_integer.exr -vcodec libx264 -pix_fmt yuv420p -preset slow -crf 18 -r 25 box-noisefree-merge_kernel_integer-output_0.mp4
...
ffmpeg -y -gamma 2.2 -r 20 -i ./out/frame%d_hlevel_1_merge_kernel_integer.exr -vcodec libx264 -pix_fmt yuv420p -preset slow -crf 18 -r 25 box-noisefree-merge_kernel_integer-output_1.mp4
...
ffmpeg -y -gamma 2.2 -r 20 -i ./out/frame%d_hlevel_2_merge_kernel_integer.exr -vcodec libx264 -pix_fmt yuv420p -preset slow -crf 18 -r 25 box-noisefree-merge_kernel_integer-output_2.mp4
